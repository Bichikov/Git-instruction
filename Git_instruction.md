...
Есть разные версии Git и поэтому на одной версии бдует спрашивать какую версию отсавляем, а каую нет,а на другой добавятся все варианты и мы в ручную будем отсекать ненужную часть.